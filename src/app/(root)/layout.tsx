...
import { ChevronDown, Clock, Heart, Mailbox, Search, ShoppingBag, User, Instagram } from "lucide-react";
import { Bolsa, Difusor, Hojas, Matcha, Mugs, TeBlanco, TeNegro, TeRojo, Tetera, Whatsapp, BanderaChile, Tiktok } from "@/lib/icons";
...
export default async function Header({
  ...
  const creditos = '/creditos.png'
  const chileexpress = '/chileexpress.png'

  return (
    <>
      <header className="bg-background py-8 fixed top-0 left-0 w-full max-h-[122px]">
        ...
        <div className="flex flex-col gap-4">
          <ul className="flex flex-col gap-3 max-w-96">
            ...
            <li className="text-primary font-normal flex flex-col gap-1">
              Paga con: <Image src={creditos} alt="Imagen de metodos de pago" width={244} height={34} />
            </li>
            <li className="text-primary font-normal flex flex-col gap-1">
              Envíos: <Image src={chileexpress} alt="Imagen de chileexpress" width={244} height={34} />
            </li>
            <li className="text-primary font-normal flex flex-col gap-1">
